...
#define DEVICE_NAME                     "hq_Nordic_Mouse"                             /**< Name of device. Will be included in the advertising data. */
...
#define INPUT_REP_BUTTONS_LEN           6///3                                           /**< Length of Mouse Input Report containing button data. */
 ...
 */
#define SCRN_RESOLUTION_X 1080
#define SCRN_RESOLUTION_Y 1920
...
static void mouse_movement_send2(int16_t x_delta, int16_t y_delta, int8_t wheel)
{
    ...
    else
    {
        ...
        APP_ERROR_CHECK_BOOL(INPUT_REP_BUTTONS_LEN == 6);
...
static void bsp_event_handler(bsp_event_t event)
{
    ...
    switch (event)
    {
        ...
        case BSP_EVENT_KEY_0:
            ...
            {
            	//if (left_move_flag) {
	                mouse_movement_send2(-MOVEMENT_SPEED, 0, 0);
				/*
				} else {

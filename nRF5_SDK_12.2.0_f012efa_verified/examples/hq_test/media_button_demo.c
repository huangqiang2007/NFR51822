...
#define MM_VOL_UP_PIN_NO                16
#define MM_VOL_DOWN_PIN_NO              17
...
static app_timer_id_t                   m_hid_button_timer_id;                      /**< Button timer. */
...
static void mouse_media_key_send(multimedia_keys_t mm_key)
{    
    uint32_t err_code;
    if (m_in_boot_mode)
        return;    
...
static void button_event_handler(uint8_t pin_no)
{
    switch (pin_no)
    {
        ...
        case DOWN_BUTTON_PIN_NO:
            mouse_movement_send(0, MOVEMENT_SPEED);
            break;
        case MM_VOL_UP_PIN_NO:
            mouse_media_key_send(MM_KEY_VOL_UP);
            break;
        case MM_VOL_DOWN_PIN_NO:
            mouse_media_key_send(MM_KEY_VOL_DOWN);
            break;
        default:
...
static void buttons_init(void)
{
    ...
    {
        {LEFT_BUTTON_PIN_NO,  false, NRF_GPIO_PIN_PULLUP, button_event_handler},
        {RIGHT_BUTTON_PIN_NO, false, NRF_GPIO_PIN_PULLUP, button_event_handler},   // Note: This pin is also BONDMNGR_DELETE_BUTTON_PIN_NO
        {UP_BUTTON_PIN_NO,    false, NRF_GPIO_PIN_PULLUP, button_event_handler},
        {DOWN_BUTTON_PIN_NO,  false, NRF_GPIO_PIN_PULLUP, button_event_handler},
        {MM_VOL_UP_PIN_NO,    false, NRF_GPIO_PIN_PULLUP, button_event_handler},
        {MM_VOL_DOWN_PIN_NO,  false, NRF_GPIO_PIN_PULLUP, button_event_handler}
    };
